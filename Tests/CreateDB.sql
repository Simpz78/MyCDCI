USE [master]
GO
/****** Object:  Database [sdi4]    Script Date: 21/10/2020 16:29:38 ******/
CREATE DATABASE [sdi4]
 CONTAINMENT = NONE 
 WITH CATALOG_COLLATION = DATABASE_DEFAULT
GO
ALTER DATABASE [sdi4] SET COMPATIBILITY_LEVEL = 110
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [sdi4].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [sdi4] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [sdi4] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [sdi4] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [sdi4] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [sdi4] SET ARITHABORT OFF 
GO
ALTER DATABASE [sdi4] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [sdi4] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [sdi4] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [sdi4] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [sdi4] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [sdi4] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [sdi4] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [sdi4] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [sdi4] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [sdi4] SET  DISABLE_BROKER 
GO
ALTER DATABASE [sdi4] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [sdi4] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [sdi4] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [sdi4] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [sdi4] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [sdi4] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [sdi4] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [sdi4] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [sdi4] SET  MULTI_USER 
GO
ALTER DATABASE [sdi4] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [sdi4] SET DB_CHAINING OFF 
GO
ALTER DATABASE [sdi4] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [sdi4] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [sdi4] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [sdi4] SET QUERY_STORE = OFF
GO
USE [sdi4]
GO
...
USE [master]
GO
ALTER DATABASE [sdi4] SET  READ_WRITE 
GO
